import { SETTINGS_SHOW_MINIMIZED_TOOLBAR_TOGGLE, SETTINGS_GRID_SET, SETTINGS_GRID_AUTO, SETTINGS_GRID_LEGACY, SETTINGS_GRID_ASPECT, SETTINGS_SHOW_ALL_STATS_TOGGLE, SETTINGS_HAND_RAISE_TOGGLE } from '../constants'
...
export interface HandRaiseToggleAction {
  type: 'SETTINGS_HAND_RAISE_TOGGLE'
}
...
export function handRaiseToggle(
): HandRaiseToggleAction {
  return {
    type: SETTINGS_HAND_RAISE_TOGGLE,
  }
}
